 ...
 * - Debug: Entender o código que não foi escrito por mim;
 *          Ajudar na refatoração de um código;
 *          Entender como um framework foi construído;
 *
 * - Step Into   (F5): entra no método em que o debug está parado.
 * - Step Over   (F6): vai para a pŕoxima linha de código.
 * - Step Return (F7): retorn ao método anterior e só funciona quando o Step Into é acionado antes.
 */
